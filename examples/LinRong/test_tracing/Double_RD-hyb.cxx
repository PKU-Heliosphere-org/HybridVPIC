...
begin_initialization {
  ...
  double nppc  = 256;         // Average number of macro particle per cell per species 
  ...
  int particle_select = 16; // track one every particle_select particles
...
#define TRANSITION_1_Y (Ly / 4)
#define TRANSITION_2_Y (Ly * 3 / 4)
