...
begin_initialization {
  ...
  double Ti_Te    = 4;//1/2.6;            // Ion temperature / electron temperature
  double theta    = 0.0*M_PI/180.0;  // Shock normal/B field angle
  double beta_i   = 0.25;              // Background ion beta
...
// In general, regions are specied as logical equations (i.e. x>0 && x+y<2) 
  set_region_field( everywhere, 0, 0, 0,
		    (BX+DBX)*cs+BY*sn, -BX*sn+BY*cs, DBZ ); // Magnetic field
