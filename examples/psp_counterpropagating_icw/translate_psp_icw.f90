!---------------------------------------
! parallel conversion for PSP counterpropagating ICW example
! 
...
!  fnames(8) = 'data/Uiy'
!  fnames(9) = 'data/Uiz'
  fnames(10) = 'data/ni_core'
  fnames(11) = 'data/Uix_core'
  fnames(12) = 'data/Uiy_core'
  fnames(13) = 'data/Uiz_core'
  fnames(14) = 'data/ni_core_copy'
  fnames(15) = 'data/aniso_core'
...
!              write(fname,"(A9,I0,A,I0,A,I0)")"fields/T.",tindex,"/fields.",tindex,".",n-1
              write(fname,"(A8,I0,A10,I0,A1,I0)")"hydro/T.",tindex,"/Hhydro_c.",tindex,".",n-1
              inquire(file=trim(fname),exist=check)
              if (check) then
